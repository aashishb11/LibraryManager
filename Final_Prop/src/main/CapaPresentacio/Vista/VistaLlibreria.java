...
public class VistaLlibreria extends JPanel implements LangListener {
    ...
    public void updateAutors(){
        ...
        VistaPrincipal vp = (VistaPrincipal) SwingUtilities.getRoot(tp);
        vp.updateAutors(false);
    }
    ...
    ActionListener IMPORT = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent actionEvent) {
            ...
            fc.setAcceptAllFileFilterUsed(false); //if true no matter the extension
            ...
            fc.addChoosableFileFilter(new FileNameExtensionFilter("lm", "lm"));
            fc.addChoosableFileFilter(new FileNameExtensionFilter("PDF", "pdf"));
            fc.addChoosableFileFilter(new FileNameExtensionFilter("Word", "docx"));
                    ...
                    for (File f : files) {
                        ...
                        try {
                            if (extension.equals("txt")) {
                                ...
                                ctrl.importDocumentXML(path);
                            } else if (extension.equals("lm")) {
                                ctrl.importDocumentLM(path);
                            } else if (extension.equals("pdf")) {
                                ctrl.importDocumentPDF(path);
                            } else if (extension.equals("docx")) {
                                ctrl.importDocumentWord(path);
                            } else {
                                String errorMessage = path + " failed to import: invalid file format";
